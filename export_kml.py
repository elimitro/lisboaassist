...
Bewusste Entscheidung gegen ein schreibendes Web-Formular ("Spot hinzufuegen"-
Button), weil das ein eigenes Backend + Auth braeuchte (siehe Chat-Diskussion).
Stattdessen bleibt Lissabon_Spots.docx die Datenhaltung; dieses Skript erzeugt
bei Bedarf (auf Zuruf, nicht live) eine KML-Datei, die manuell in Google My
Maps importiert wird -- ein Ein-Klick-Import, kein Medienbruch zur echten
Maps-App unterwegs.

KML-Ordnerstruktur = My-Maps-Ebenen:
Google My Maps liest <Folder>-Elemente innerhalb einer KML als separate
Layer/Ebenen ein. Jede Kategorie aus spots.json (Kultur & Events, Cafes &
Szene, Outdoor & Natur) wird so automatisch zu einer eigenen, einzeln
ein-/ausblendbaren Ebene in der importierten Karte.
